...
with tool_cols[1]:
    if st.button("🧬 Molecular Modeling", key="molecular", use_container_width=True):
        st.switch_page("pages/2_Molecular_Modeling.py")
    st.markdown("""
    <div class="tool-card">
        <div class="tool-icon">🧬</div>
...
with tool_cols[2]:
    if st.button("💊 Pharmacology", key="pharmacology", use_container_width=True):
        st.switch_page("pages/3_Pharmacology_Analysis.py")
    st.markdown("""
    <div class="tool-card">
        <div class="tool-icon">💊</div>
...
with tool_cols2[1]:
    if st.button("✍️ Academic Writing", key="writing", use_container_width=True):
        st.switch_page("pages/5_Academic_Writing.py")
    st.markdown("""
    <div class="tool-card">
...
with tool_cols3[0]:
    if st.button("🌍 Population Analysis", key="population", use_container_width=True):
        st.switch_page("pages/7_Population_Analysis.py")
    st.markdown("""
    <div class="tool-card">
        <div class="tool-icon">🌍</div>
...
with tool_cols3[1]:
    if st.button("⚡ Advanced Analytics", key="quantum", use_container_width=True):
        st.switch_page("pages/8_Quantum_Analysis.py")
    st.markdown("""
    <div class="tool-card">
        <div class="tool-icon">⚡</div>
...
with tool_cols3[2]:
    if st.button("🎯 Research Methods", key="ubuntu", use_container_width=True):
        st.switch_page("pages/9_Ubuntu_Philosophy.py")
    st.markdown("""
    <div class="tool-card">
        <div class="tool-icon">🎯</div>
